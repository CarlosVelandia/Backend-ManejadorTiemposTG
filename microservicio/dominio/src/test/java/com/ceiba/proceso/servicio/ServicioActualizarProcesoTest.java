...
public class ServicioActualizarProcesoTest {
    ...
    @Test
    public void validarExistenciaPreviaEtapa() {
        //arrange
        Proceso proceso = new ProcesoTestDataBuilder().build();
        Mockito.when(repositorioProceso.existeId(proceso.getId())).thenReturn(true);
        ...
        //act - assert
        BasePrueba.assertThrows(() -> servicioActualizarProceso.ejecutar(proceso), ExcepcionProceso.class, EL_ETAPA_NO_EXISTE);
    }
...
/*    @Test
    ...
    public void validarMaximoProcesosEtapaTest() {
        ...
        // act - assert
        BasePrueba.assertThrows(() -> servicioActualizarProceso.ejecutar(proceso), ExcepcionProceso.class, LIMITE_PROCESOS_POR_ETAPA_ALCANZADO);
    }
