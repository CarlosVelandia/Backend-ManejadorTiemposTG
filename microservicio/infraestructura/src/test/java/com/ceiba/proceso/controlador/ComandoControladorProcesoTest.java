...
public class ComandoControladorProcesoTest {
    ...
    private static final Long ID_ETAPA_CREAR = 1l;
    ...
    private static final Long ID_ETAPA_ACTUALIZAR = 1l;
    ...
    public void crear() throws Exception{
        // arrange
        ComandoProceso proceso = new ComandoProcesoTestDataBuilder().conIdUsuario(ID_USUARIO_CREAR).conIdEtapa(ID_ETAPA_CREAR).conFechaCompra(FECHA_COMPRA_CREAR).conValor(VALOR_CRAR).build();
    ...
    public void actualizar() throws Exception {
        // arrange
        Long id = 2L;
        ComandoProceso proceso = new ComandoProcesoTestDataBuilder().conIdUsuario(ID_USUARIO_ACTUALIZAR).conIdEtapa(ID_ETAPA_ACTUALIZAR).conFechaCompra(FECHA_COMPRA_ACTUALIZAR).conValor(VALOR_ACTUALIZAR).build();
